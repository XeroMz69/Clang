...
SEARCH_DIR("/__w/Bebas/Bebas/clang-main/install/x86_64-pep/lib"); SEARCH_DIR("/__w/Bebas/Bebas/clang-main/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
